...
#define PERF_MEM_OP_MTE_TAG			0x0001 /* MTE tag */
#define PERF_MEM_OP_NESTED_VIRT			0x0002 /* Nested virtualization */
#define PERF_MEM_OP_MEMCPY			0x0004 /* Memory copy */
#define PERF_MEM_OP_MEMSET			0x0008 /* Memory set */
#define PERF_MEM_OP_SIMD			0x0010 /* SIMD */
