...
#define is_simd_op(op)		(!!((op) & (ARM_SPE_OP_SIMD_FP | ARM_SPE_OP_SVE | ARM_SPE_OP_SME | ARM_SPE_OP_ASE)))

/* Some memory operations come from the other types, do a special check for SIMD */
