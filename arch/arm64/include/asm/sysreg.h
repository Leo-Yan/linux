...
#define TRBSR_EL1_BSC_NOT_STOPPED	UL(0)
#define TRBSR_EL1_BSC_FILLED		UL(1)
#define TRBSR_EL1_BSC_TRIGGER_EVENT	UL(2)
#define TRBSR_EL1_BSC_MANUAL_STOP	UL(3)
#define TRBSR_EL1_BSC_BUF_SIZE		UL(4)
