...
#define TRBE_EC_BUF_MGMT	0
#define TRBE_EC_GPT_FAULT	0x1e
...
u64 __trbe_next_limit(struct perf_output_handle *handle);
u64 __trbe_next_count(struct perf_output_handle *handle);
#endif
